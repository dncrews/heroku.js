 ...
 *
 * @example
 * // Remove Heroku pipelines from the account
 * api.deleteFeature('pipelines', function(err, res) {});
 * @example
 ...
 *
 * @example
 * api.getFeature('pipelines', function(err, res) {});
 * @example
 ...
 * api.postFeature('pipelines', function(err, res) {});
 * @example
